...
def plot_author_distribution(stats, output_dir="."):
    ...
    ax.set_title("Authorship Distribution: From Solo to Collaboration", fontsize=14, fontweight="bold")
...
def plot_citation_weighted_distribution(stats, output_dir="."):
    ...
    ax.set_title("Citation Impact: Single-Author Papers' Share of Citations", fontsize=14, fontweight="bold")
    ax.grid(True, alpha=0.3)
    plt.tight_layout()
